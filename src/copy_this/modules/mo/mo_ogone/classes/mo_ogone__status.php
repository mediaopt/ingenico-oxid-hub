...
/**
 * $Id: mo_ogone__status.php 6 2012-12-12 10:16:57Z martin $ 
 */
...
class mo_ogone__status
{
  ...
  const SHA_IN_MISSMATCH                                  = 50001184;
  ...
  static protected $statusTextByCode = array(
      ...
      50001184 => 'SHA-IN Missmatch',
  );

  static public function getStatusTextForCode($code)
  {
    return self::$statusTextByCode[$code];
  }
   ...
   */
  static public function isOxidThankyouStatus($code)
  {
    switch ($code)
    {
      case self::ORDER_STORED:            // 4
      case self::WAITING_CLIENT_PAYMENT:  // 41
      case self::AUTHORIZED:              // 5
      case self::AUTHORIZATION_WAITING:   // 51
      case self::AUTHORIZATION_NOT_KNOWN: // 52
      case self::PAYMENT_REQUESTED:       // 9
      case self::PAYMENT_PROCESSING:      // 91
      case self::PAYMENT_UNCERTAIN:       // 92
        return true;
    }
    return false;
  }
   ...
   */
  static public function isOxidOkStatus($code)
  {
    switch ($code)
    {
      case self::AUTHORIZED:        // 5
   ...
   */
  static public function getTranslatedStatusMessage($code)
  {
   ...
   */
  static public function isStornoStatus($code)
  {
    if ($code == self::CANCELLED_BY_CLIENT)
    {
      return true;
    }
    return false;
