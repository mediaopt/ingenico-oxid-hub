...
class mo_ingenico__capture extends oxAdminDetails
{

    const MO_INGENICO__CAPTURE_OPERATION = 'SAL';
     ...
     * to Smarty engine, returns name of template file "mo_ingenico__capture.tpl".
     *
     * @return string
     */
    public function render()
    {
        ...
        return 'mo_ingenico__capture.tpl';
    }
    ...
    /**
     * controller function. Creates an aftersales operation to capture an amount depending on chosen
    ...
    public function capture()
    {
        ...
        $params = $paramBuilder->build($oxOrder, $articles, self::MO_INGENICO__CAPTURE_OPERATION, $includeShipment, $includeGiftcard);
