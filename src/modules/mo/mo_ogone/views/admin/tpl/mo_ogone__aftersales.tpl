...
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="[{$mo_ogone__cl}]">
</form>
[{if !$edit->mo_ogone__isOgoneOrder()}]
    this is not an ogone payment
[{else}]
<link rel="stylesheet" href="[{$oViewConf->getModuleUrl('mo_ogone','out/src/css/admin/mo_ogone__admin.css')}]">
[{if $success_message}]
...
[{/if}]
    ...
    <form name="search" id="search" action="[{$oViewConf->getSelfLink()}]" method="post">
        ...
        <input type="hidden" name="cl" value="[{$mo_ogone__cl}]">
        <input type="hidden" name="oxid" value="[{$oxid}]">
        <input type="hidden" name="fnc" value="[{$mo_ogone__fnc}]">
    <tr>
