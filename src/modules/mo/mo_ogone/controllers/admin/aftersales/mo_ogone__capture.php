...
class mo_ogone__capture extends oxAdminDetails
{
    ...
    const MO_OGONE__CAPTURE_OPERATION = 'SAL';
     ...
     * to Smarty engine, returns name of template file "mo_ogone__capture.tpl".
     *
     * @return string
     */
    ...
    public function capture()
    {
        ...
        $params = $paramBuilder->build($oxOrder, $articles, self::MO_OGONE__CAPTURE_OPERATION, $includeShipment, $includeGiftcard);
